...
//lpm_compare DEVICE_FAMILY="Cyclone IV GX" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=32 alb dataa datab
...
module  ALU_COMPARE_UNSIGNED_cmpr
	( 
	alb,
	dataa,
...
`endif
	...
	assign
		alb = wire_alb_int;
endmodule //ALU_COMPARE_UNSIGNED_cmpr
//VALID FILE
...
module ALU_COMPARE_UNSIGNED (
	...
	ALU_COMPARE_UNSIGNED_cmpr	ALU_COMPARE_UNSIGNED_cmpr_component (
				.dataa (dataa),
				.datab (datab),
				.alb (sub_wire0));
