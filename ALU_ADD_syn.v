...
//lpm_add_sub DEVICE_FAMILY="Cyclone IV GX" LPM_DIRECTION="ADD" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=32 ONE_INPUT_IS_CONSTANT="NO" dataa datab result
...
module ALU_ADD (
	...
	ALU_ADD_add_sub	ALU_ADD_add_sub_component (
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
